...
|-------|---------|---------|--------|
| oxigraph (fork) | 0.6.0 | MIT OR Apache-2.0 | OK -- fork compliant |
| oxigraph-tikv | 0.6.0 | MIT OR Apache-2.0 | OK |
| oxigraph-shacl | 0.6.0 | MIT OR Apache-2.0 | OK |
| oxigraph-server | 0.6.0 | MIT OR Apache-2.0 | OK |
...
| oxrocksdb-sys | 0.6.0 | MIT OR Apache-2.0 | OK |
| oxigraph-cli | 0.6.0 | MIT OR Apache-2.0 | OK |
| pyoxigraph | 0.6.0 | MIT OR Apache-2.0 | OK (not distributed) |
| oxigraph-js | 0.6.0 | MIT OR Apache-2.0 | OK (not distributed) |
| oxigraph-testsuite | 0.6.0 | MIT OR Apache-2.0 | OK (dev only) |
